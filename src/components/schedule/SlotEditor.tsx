  ...
  return (
    <div className="fixed inset-0 z-40 flex justify-end" role="dialog" aria-modal="true">
      <button
        aria-label="Tutup"
        onClick={onClose}
        className="absolute inset-0 cursor-default bg-canvas/60 backdrop-blur-[2px]"
      />

      <aside className="relative flex h-full w-full max-w-md flex-col border-l border-hairline-strong bg-surface-overlay shadow-2xl">
